    ...
    <section>
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <form
            onSubmit={handlerDiscountCoupon}
          ...
          >
            <div className="flex gap-4 items-end">
              <Input
                ...
                name="DiscountValue"
                disabled={discountCoupon && discountCoupon.percentage}
              />
              {discountCoupon && discountCoupon.percentage ? (
                <button className="bg-blue-500 text-white px-2 py-1 h-fit text-xs font-medium rounded-full">
                  Quitar cupón
                </button>
              ) : (
                <button className="bg-blue-500 text-white px-2 py-1 h-fit text-xs font-medium rounded-full">
          ...
          <div className="flex justify-between mt-10">
            {discountCoupon && discountCoupon.percentage ? (
              <div>
                ...
                <p>
                  Total con descuento: $
                  {totalPrice - (totalPrice * discountCoupon.percentage) / 100}
                </p>
              </div>
            ) : (
